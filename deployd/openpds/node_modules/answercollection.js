...
function OAuthServerCallback(token, callback){
var scope_array = new Array();
var options = {
    host: 'celldata.media.mit.edu',
    port: 8041,
    path: '/get_key_from_token?bearer_token='+token+'&scope=funf_write',
    method: 'GET'
  };
...
AnswerCollection.prototype.handle = function (ctx, next) {
  ...
  switch(ctx.req.method) {
    case 'GET':
      ...
      if(!ctx.req.isRoot)
      {
        OAuthServerCallback(ctx.query.bearer_token, function(scope_array){
